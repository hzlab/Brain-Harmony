...
def get_args_parser():
    ...
    parser.add_argument(
        "--data_portion", default=1.0, type=float, help="portion of data to load"
    )
    ...
    parser.add_argument("--num_latent_tokens", default=128, type=int)
    parser.add_argument(
        "--data_root_dir",
        default="/scratch/Projects/project_312_HelenZhou/save_encoder_embed/pretrain_base",
        help="data_root_dir",
    )
    return parser
...
def main(args):
    ...
    dataset_train = GenerateEmbedDataset(
        root_dir=args.data_root_dir, portion=args.data_portion
    )
    print(dataset_train)
    ...
    model = models_one_tok_reg.__dict__[args.model](
